...
$getnotifquery = mysqli_query($con,"SELECT * FROM notifications WHERE NID='$ntid'");
$notifdata = mysqli_fetch_assoc($getnotifquery);

    if ($notifdata['ViewStatus'] == 0){
        $updatenotifquery = mysqli_query($con,"UPDATE notifications SET ViewStatus=1 WHERE NID='$ntid'");
    }
    else {
        //no arg
    }
...
<div id="viewport">
    ...
    $getTickets = mysqli_query($con,"SELECT * FROM tickets WHERE TID='$tid'");
