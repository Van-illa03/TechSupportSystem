  ...
  <!-- Content -->
      <div id="content" class="container">
        ...
        <div class="container-fluid" id="content-container">
            <h2 class="text-center">View Deleted Ticket</h2>
                    ...
                    <form action="ticketprocess.php" method="POST">
                        <div class="card-body">
                            ...
                            <div class="row mx-auto">
                                ...
                                <div class="col-4">
                                    <a href="permadelete.php?id=<?php echo $chosenTicket['TID'];?>" class="btn btn-danger" title="Delete Ticket">Delete Permanently</a>
                                </div>
                            </div>
                        </div>
