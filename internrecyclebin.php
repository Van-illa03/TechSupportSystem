    ...
    <div id="content" class="container">
        ...
        <div class="container" id="content-container">
            ...
            <table class="table table-hover table-bordered table-striped" style="border-color:#224375" id="dtHorizontalExample" >
                ...
                while($tickets = mysqli_fetch_assoc($getTickets)){  // fetching all the tickets and displaying it through a while loop
                    ...
                    <tr>
                        ...
                        <td class="text-center"><a href="permadelete.php?id=<?php echo $tickets['TID'];?>" class="delete" title="Delete Ticket"><i class="bi bi-trash text-danger"></i></a>
                            <a href="viewrecycledticket.php?id=<?php echo $tickets['TID'];?>" class="View" title="View Ticket"><i class="bi bi-eye-fill text-primary"></i></a>
...
<script>
    $(document).ready(function (){
        ...
        if (viewcount !== "0") { //if there are notifications that is not viewed, the badge will be displayedv
